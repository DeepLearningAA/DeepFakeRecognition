...
res_next50.requires_grad_(False)
...
for fold in range(k):
    for j in range(1):
        ...
        train_fake_path = f'../../data/splitted/train_resnext_128_massive_data_augmentation/train_{fold}/fake'
        train_real_path = f'../../data/splitted/train_resnext_128_massive_data_augmentation/train_{fold}/real'
...
test_fake_path = f'../../data/splitted/test_resnext_128_massive/test/fake'
test_real_path = f'../../data/splitted/test_resnext_128_massive/test/real'
